...
def swine_align(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4a
    "*** YOUR CODE HERE ***"
    Max, Min = max(player_score,opponent_score), min(player_score,opponent_score)
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    #PROBLEM 6
        if (who ==0 and extra_turn(score0, score1)) or (who ==1 and extra_turn(score1, score0)):
            who = who
        else: who = other(who)
        endcond = max(score0, score1)  
    ...
    # misleading,please see the above
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        else: return announce_highest(who, score, running_high)
    return say
    # END PROBLEM 7
...
def make_averaged(original_function, trials_count=1000):
    ...
    def f(*args):
        ...
        while i < trials_count:
            gain += original_function(*args)
            i += 1
        return gain / trials_count
    return f
    # END PROBLEM 8
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=3):
    ...
    if extra_turn(new_score, opponent_score):
        return 0
    else:return bacon_strategy(score, opponent_score, cutoff, num_rolls)
    #return 6  # Replace this statement
    # END PROBLEM 11

def lead_win(score, opponent_score):
    return 
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    The strategy always_roll(4) is the best strategy under normal circumstances. 
    It has both high expectations and low risks.
    So, this strategy should be chosen if there are no special circumstances.
    And I will also try to trigger extra rounds by use the bacon strategy beacsue it is stablize.
    If I can win by rolling 0, 2 or 3 dice, I should do that.
    And the average_win_rate is about 0.65.
    """
