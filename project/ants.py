...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        place = self.place
        distance = 0
        while place != beehive and not (self.min_range <= distance <= self.max_range and place.bees):
...
# END Problem EC
    ...
    def __init__(self, armor=1):
        ...
        "*** YOUR CODE HERE ***"
        super().__init__(armor)
        self.is_True = QueenAnt.is_True
        QueenAnt.is_True = False
        # END Problem EC
    ...
    def reduce_armor(self, amount):
        ...
        "*** YOUR CODE HERE ***"
        super().reduce_armor(amount)
        if self.armor <= 0 and self.is_True:
            bees_win()
        # END Problem EC
...
def make_scare(action, bee):
    ...
    def new_action(gamestate):
        bee.is_scared = True
        bee.current_direction = False
        action(gamestate)
        bee.current_direction = True
    return new_action
    # END Problem Optional 4
...
class LaserAnt(ThrowerAnt):
    ...
    def calculate_damage(self, distance):
        # BEGIN Problem Optional 5
        damage = 2 - distance * 0.2 - self.insects_shot * 0.05
        return max(damage, 0)
        # END Problem Optional 5
