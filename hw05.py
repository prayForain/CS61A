    ...
    def vend(self):
        ...
        if self.funds < self.price:
            ...
            if remain == 0:
                ...
                return 'Here is your {} and ${} change.'.format(self.product, remain)
...
class Mint:
    ...
    def update(self):
        "*** YOUR CODE HERE ***"
        self.year = type(self).current_year
...
def is_bst(t):
    ...
    return all([is_bst(b) for b in t.branches]) and bst_min(t.branches[1]) > t.label and bst_max(t.branches[0]) <= t.label
